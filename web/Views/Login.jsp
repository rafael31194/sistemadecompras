        ...
        <div class="login-page">
            <div class="form">
                <s:form action="/LoginAction" cssClass="login-form">
                    ...
                    <img   src="<s:url value='/Recursos/Imagenes/Escudo_El_Salvador.svg.png'/>" width="600px" height="480px" />
                    <br>
                    <h2>Control De Compras de Instituciones Gubernamentales</h2>
                    <s:textfield label="Usuario" key="user" />

                    <s:password label="Contraseña" key="password" />
                    <s:submit value="Ingresar" cssClass="form-button" ></s:submit>
